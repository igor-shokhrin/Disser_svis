...
get_dictToSend = {'cmd': 'get_plate_from_image', 'path': '[./lib/test/1.jpg , ./lib/test/2.jpg, https://1gai.ru/uploads/posts/2019-08/1565362193_22111.jpg]'}  # Get command help
# POST
# post_dictToSend = {'cmd': 'add_value_to_table', 'table': 'passes', 'data': '[Uzziel, Gonzalez, 6, 4]'}  # Add data to table passes
...
res = requests.get('http://'+ip+':7000/api_rcgn', json=get_dictToSend) # get_val, get_data, get_tables, get_column_name
# res = requests.post('http://192.168.43.33:5000/tests/endpoint', json=dictToSend)
print('response from server:', res.text)
