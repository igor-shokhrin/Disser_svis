...
def plate_recognize(api_key ="ea3da3850cf3369d69125d386efa3c27f4034501", regions = "ru", sdk_url = None, camera_id = None, paths = ["./lib/test/2.jpg"], mmc = None):
    results = []
    for path in paths:
...
def main():
    print(plate_recognize(paths=["./lib/test/2.jpg","./lib/test/4.jpg"]))
